...
file_to_save = os.path.join("Analysis_Projects","Election_Analysis","Analysis", "election_analysis.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (f"{county_name}: {vote_percentage_county:.1f}% ({votes_percounty:,})\n")
